...
Borel parameter denoted by $M^2$.  The axial-current invariant amplitude is
decomposed as
\begin{align}
  \widehat\Pi_A
  &=
  ...
  \left[
    -\frac14\left(\mathbb A(u_0)-8\bar H_\gamma(u_0)\right)
...
\begin{align}
  \bar H_\gamma(u_0)
  &=\int_0^{u_0}du\,(u_0-u)h_\gamma(u),&
  \Psi^v(u_0)
  &=\int_0^{u_0}du\,\psi^v(u),
  \label{eq:hbar-psi-def}
\end{align}
...
\begin{align}
  ...
  +\frac{m_c}{m_c+m_s}\,
  \widehat\Pi_A^{(\chi\phi_\gamma,\mathbb A,\bar H_\gamma)}
  +\widehat\Pi_B^{(3p)} .
...
$\chi_s\phi_\gamma$ and $\mathbb A,\bar H_\gamma$ pieces.  The perturbative
