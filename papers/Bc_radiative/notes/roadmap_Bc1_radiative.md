...
\]
The FeynCalc files in `scripts` do precisely this and store the raw
and reduced projections in `outputs`.
...
1. Run `scripts/step1_hard_photon_numerators.wl` to generate the raw
   hard-photon traces.
2. Run `scripts/step2_ps_e1_triangle_reduction.wl` for the
   \(B_c\gamma\) E1 projector.
3. Run `scripts/step2_vec_epsilon_A_reduction.wl` and
   `scripts/step2_vec_epsilon_B_reduction.wl` for the diagnostic
...
`scripts/step1_hard_photon_numerators.wl`. It generates
`outputs/step1_hard_photon_numerators.txt`.
...
The auxiliary file `scripts/stage0_e1_benchmark.py` produces a
nonrelativistic E1 sanity check in `outputs/stage0_e1_benchmark.md`.
...
The script `scripts/step2_ps_e1_triangle_reduction.wl` projects the
...
The split scripts
`scripts/step2_vec_epsilon_A_reduction.wl` and
`scripts/step2_vec_epsilon_B_reduction.wl` should be used instead of
...
The script `scripts/bc_ps_complete_analysis.py` turns the compact
...
`scripts/bc_vec_complete_analysis.py`.  The main output figures are

- `outputs/bc_vec_fbcstar_standard_M2_stability.pdf`;
- `outputs/bc_vec_standard_g1_M2_stability.pdf`;
- `outputs/bc_vec_standard_g2_M2_stability.pdf`;
- `outputs/bc_vec_standard_gamma1_M2_stability.pdf`;
- `outputs/bc_vec_standard_gamma2_M2_stability.pdf`.
...
- `outputs/bc1_twopoint_residue_grid.csv`
- `outputs/bc1_twopoint_residue_summary.csv`
- `outputs/bc_ps_complete_grid.csv`
- `outputs/bc_ps_complete_grid_summary.csv`
- `outputs/bc_ps_complete_monte_carlo.csv`
- `outputs/bc_ps_complete_monte_carlo_summary.csv`
- `outputs/bc_ps_g1_M2_stability.pdf`
- `outputs/bc_ps_g2_M2_stability.pdf`
- `outputs/bc_ps_gamma1_mc_hist.pdf`
- `outputs/bc_ps_gamma2_mc_hist.pdf`
- `outputs/bc_vec_fbcstar_twopoint_grid.csv`
- `outputs/bc_vec_fbcstar_twopoint_summary.csv`
- `outputs/bc_vec_complete_grid.csv`
- `outputs/bc_vec_complete_grid_summary.csv`
- `outputs/bc_vec_complete_monte_carlo.csv`
- `outputs/bc_vec_complete_monte_carlo_summary.csv`
- `outputs/bc_vec_complete_summary.txt`
...
- `scripts/step3_ps_g2_topology_inventory.py`;
- `scripts/step3_ps_g2_single_line_cphoton.wl`;
- `scripts/step3_ps_g2_single_line_bbarphoton.wl`;
- `scripts/step3_ps_g2_open_pair_cphoton.wl`;
- `scripts/step3_ps_g2_open_pair_bbarphoton.wl`;
- `scripts/step3_ps_g2_projection_summary.py`;
- `scripts/step3_ps_g2_denominator_bookkeeping.py`.

The corresponding raw and summary outputs are:

- `outputs/step3_ps_g2_topology_inventory.{txt,csv}`;
- `outputs/step3_ps_g2_single_line_cphoton.txt`;
- `outputs/step3_ps_g2_single_line_bbarphoton.txt`;
- `outputs/step3_ps_g2_open_pair_cphoton.txt`;
- `outputs/step3_ps_g2_open_pair_bbarphoton.txt`;
- `outputs/step3_ps_g2_projection_summary.{txt,csv}`;
- `outputs/step3_ps_g2_denominator_bookkeeping.{txt,csv}`.
...
- `scripts/bc_ps_g2_screening_estimate.py`,

and the outputs are

- `outputs/bc_ps_g2_screening_estimate.csv`;
- `outputs/bc_ps_g2_screening_estimate.txt`.
...
- `scripts/bc_ps_g2_corrected_summary.py`,

with outputs

- `outputs/bc_ps_g2_corrected_summary.csv`;
- `outputs/bc_ps_g2_corrected_summary.txt`.
...
- `scripts/step3_ps_g2_denominator_reduction.wl`;
- `scripts/step3_ps_g2_denominator_reduction_summary.py`;
- `outputs/step3_ps_g2_denominator_reduction.csv`;
- `outputs/step3_ps_g2_denominator_reduction_summary.{txt,csv}`.
...
- `scripts/step3_vec_g2_denominator_reduction.wl`;
- `scripts/step3_vec_g2_denominator_reduction_summary.py`.

The generated outputs are

- `outputs/step3_vec_g2_denominator_reduction.csv`;
- `outputs/step3_vec_g2_denominator_reduction_summary.csv`;
- `outputs/step3_vec_g2_denominator_reduction_summary.txt`.
...
- `scripts/step3_vec_g2_contact_support_audit.py`.
- `scripts/step3_vec_g2_contact_borel_admissibility.py`.

The outputs are

- `outputs/step3_vec_g2_contact_support_audit.csv`;
- `outputs/step3_vec_g2_contact_support_summary.csv`;
- `outputs/step3_vec_g2_contact_support_audit.txt`;
- `outputs/step3_vec_g2_contact_active_candidates.csv`.
- `outputs/step3_vec_g2_contact_borel_admissibility.csv`;
- `outputs/step3_vec_g2_contact_borel_admissibility_summary.csv`;
- `outputs/step3_vec_g2_contact_borel_admissibility.txt`.
...
- `scripts/bc_ps_g2_all_positive_direct_borel.py`;
- `scripts/bc_ps_g2_all_positive_mc_update.py`;
- `scripts/bc_vec_g2_all_positive_direct_borel.py`;
- `scripts/bc_vec_g2_all_positive_mc_update.py`;
- `scripts/step3_ps_g2_contact_borel_admissibility.py`.

The corresponding output files are

- `outputs/bc_ps_g2_all_positive_direct_borel_grid.csv`;
- `outputs/bc_ps_g2_all_positive_monte_carlo_summary.csv`;
- `outputs/bc_vec_g2_all_positive_direct_borel_grid.csv`;
- `outputs/bc_vec_g2_all_positive_monte_carlo_summary.csv`;
- `outputs/step3_ps_g2_contact_borel_admissibility_summary.csv`.
...
- `scripts/bc_vec_projector_width_audit.py`,

with outputs

- `outputs/bc_vec_projector_width_audit.csv`;
- `outputs/bc_vec_projector_width_audit.txt`.
...
- `scripts/bc_vec_mixing_sign_audit.py`,
- `scripts/step2_vec_tensor_sign_independent_audit.wl`,

with outputs

- `outputs/bc_vec_mixing_sign_audit.txt`;
- `outputs/bc_vec_mixing_sign_audit_grid.csv`;
- `outputs/bc_vec_mixing_sign_audit_summary.csv`;
- `outputs/bc_vec_mixing_sign_audit_central.csv`;
- `outputs/bc_vec_mixing_sign_audit_components.csv`;
- `outputs/bc_vec_mixing_sign_audit_no_mixing.csv`;
- `outputs/bc_vec_mixing_sign_audit_literature.csv`;
- `outputs/step2_vec_tensor_sign_independent_audit.txt`;
- `outputs/step2_vec_tensor_sign_independent_audit.csv`.
...
- `notes/Bc1_final_comparison_table.tex`;
- `notes/Bc1_final_comparison_table.pdf`.
