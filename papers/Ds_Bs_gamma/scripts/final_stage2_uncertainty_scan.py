"""Matched Rohrwild-nonlocal Stage-2 uncertainty scan for Ds1 -> Ds gamma.
...
continuum threshold.  The transition baseline excludes ordinary local
condensates and includes the nonlocal S_gamma/T4^gamma sector.
"""
...
def main():
    ...
    lines = [
        "Rohrwild-nonlocal matched Stage-2 uncertainty scan",
        "==================================================",
