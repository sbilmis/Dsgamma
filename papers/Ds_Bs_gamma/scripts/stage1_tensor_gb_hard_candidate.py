"""Stage-1 tensor-current hard contribution in the diagonal spectral scheme.
...
For the tensor current the core contains ``p^2/(p.q)``.  The adopted
implementation uses the diagonal double-dispersion identification
...
def main():
    ...
    lines = [
        "Stage-1 tensor-current hard contribution",
        "==========================================",
        ...
        "Includes the hard term and complete tensor-current two-particle DAs.",
        "Does not include the Stage-2 three-particle DAs.",
    ]
