...
\path{Bc_gamma/outputs/step3_ps_g2_projection_summary.csv}.

This completes the numerator-projection stage of the radiative
gluon-condensate workbench.  It is not yet a numerical condensate correction
to the decay width.  The next step is to attach the denominator powers to each
projected row, perform the double-dispersion/double-Borel reduction, and
