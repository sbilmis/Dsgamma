...
For comparison with other theory, Martín-González et al. quote representative
...
\]
Their table also lists earlier model values
\[
...
\begin{table}[h]
\centering
\caption{Comparison with representative E1 model widths.}
\scriptsize
\setlength{\tabcolsep}{4pt}
