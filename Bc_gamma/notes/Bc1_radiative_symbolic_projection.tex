...
\]
Using \(M_V^2=5\)--\(8~\GeV^2\) and \(s_{0,V}=40\)--\(44~\GeV^2\) gives
\[
  f_{\Bcst}^{\rm LO}=0.753\,[0.693,0.808]~\GeV .
\]
Because this is much larger than the commonly used reference value
\(f_{\Bcst}=0.384\pm0.038~\GeV\), the vector-channel widths are strongly
normalization dependent.  We therefore quote both versions:
...
& LO vector two-point \(f_{\Bcst}\)
& \(-0.0454\,[-0.0487,-0.0425]~\GeV^{-1}\)
& \(24.8\,[21.8,28.5]\)\\
\(\BcOne(6750)\to\Bcst\gamma\)
& LO vector two-point \(f_{\Bcst}\)
& \(+0.0970\,[0.0903,0.104]~\GeV^{-1}\)
& \(120\,[104,137]\)\\
\(\BcOne(6743)\to\Bcst\gamma\)
...
and an explicit \(f_{\Bcst}\) normalization.  They should nevertheless be
