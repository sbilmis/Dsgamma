...
\begin{itemize}
  ...
  \item A compact uncertainty table for the paper.  The Monte Carlo and
  one-at-a-time outputs are now available, but the manuscript should present
  only the main quoted band and the dominant sources, not every diagnostic row.
