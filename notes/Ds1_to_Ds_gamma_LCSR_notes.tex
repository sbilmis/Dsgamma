...
off-diagonal two-point overlap is calibrated from the local-QCDSR value
$f_1=f_{D_{s1}(2460)}=0.345\pm0.017~\GeV$ from Wang, and the same overlap then
predicts $f_2$.  Numerically this gives
...
\begin{table}[htbp]
  ...
  calibrated with $f_{D_{s1}(2460)}=0.345\pm0.017~\GeV$; a fully matched-scale
...
\begin{table}[htbp]
  ...
  \begin{tabular}{llll}
    ...
    $\Dsone$ physical-current residues
      ...
      & $f_1$ from local QCDSR; $f_2$ from Stage-3 overlap calibration; Wang2015\\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lll}
    ...
    Wang2015 & heavy-light decay constants from QCDSR
      & Stage-3 $f_1=f_{D_{s1}(2460)}$ calibration\\
...
\begin{itemize}
  ...
  residues $f_1\simeq0.345~\GeV$ and $f_2\simeq0.38~\GeV$;
