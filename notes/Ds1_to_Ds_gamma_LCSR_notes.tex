...
percentile intervals.  The table is intentionally explicit about the photon
input, mixing input, normalization status, normalization constants, form factor
$G$, and width $\Gamma$, so that no reader has to infer which scenario is being
quoted.
