...
\begin{table}[htbp]
  ...
  \begin{tabular}{llllc}
    \toprule
    Sector & Decay & Photon input & Mixing input & $\Gamma$ (keV)\\
    \midrule
    $D_s$ final
  ...
  \caption{Current combined summary of $D_{s1}$ and $B_{s1}$ radiative widths.
  The $B_s$ rows should be treated as working results until dedicated
  $B_{s1}$ decay constants replace the heavy-quark-scaled temporary inputs.}
