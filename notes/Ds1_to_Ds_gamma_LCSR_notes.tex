...
\begin{table}[htbp]
  ...
  pure $J_A$ scale.  The physical mixed-current residues require assumptions
  about the $AA/BB$ overlap and are therefore not directly determined by the
  pure axial-current benchmark.  All decay constants are in GeV.  A
