...
\begin{itemize}
  ...
  \item A transversality/Ward-identity check.  The extracted E1 structure is
  transverse by construction, but the paper should include either a symbolic
  replacement $\epsilon_\gamma\to q$ at the invariant-amplitude level or a
  short explanation of how contact terms are absent in the chosen projected
  structure.
