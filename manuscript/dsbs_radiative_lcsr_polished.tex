...
collected by Bondar and Milstein.  For channels with a vector final state,
$D_s^*\gamma$ or $B_s^*\gamma$, we quote the literature values but leave our
entry blank because those transitions require separate LCSR correlators and are
not part of the present calculation.
